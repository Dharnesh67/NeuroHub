      ...
      >
        ...
        <div className="flex items-center justify-end px-2 pt-2">
          <button
            ...
            className="group rounded-full border border-[var(--sidebar-border)] bg-[var(--sidebar)] p-2 shadow-lg transition-all duration-200 hover:border-[var(--sidebar-primary)] hover:bg-[var(--sidebar-accent)] focus:ring-2 focus:ring-[var(--sidebar-ring)] focus:outline-none active:scale-95 cursor-pointer"
                ...
                <div className="flex min-w-0 flex-col">
                  ...
                  {userInfo.hasGoogle && (
                    <a
                      ...
                      className="mt-1 text-xs text-[var(--sidebar-primary)] hover:underline cursor-pointer"
                    >
